    ...
    async execute(interaction) {
        try {
            ...
            if (interaction.isChatInputCommand()) {
                 ...
                 *
                 * /verify is allowed without verification.
                 * Other commands can be restricted later.
                 */

                if (
                    interaction.commandName !== "verify" &&
                    interaction.commandName !== "service-role-panel" &&
                    interaction.commandName !== "order-panel"
                ) {
            ...
            if (
                ...
                const modal = new ModalBuilder()
                    ...
                    .setTitle("Add / Update Torn API Key");
                ...
                const warning =
                    new TextInputBuilder()
                        .setCustomId("warning")
                        .setLabel(
                            "Do not add your personal information."
                        )
                        .setStyle(TextInputStyle.Short)
                        .setValue(
                            "Do not add your personal information."
            ...
            if (
                ...
                const staffEmbed =
                    new EmbedBuilder()
                        .setColor(0x00ff00)
                        .setTitle(
                            "Torn HQ Staff Information"
                        )
                        .setDescription(
                            `**Tornuser [ID]**\n` +
                            `${interaction.user.username}\n\n` +
                            `**Profile Link:** https://www.torn.com/profiles.php?XID=${interaction.user.id}\n` +
                            `**Status:** Online\n` +
                            `**Faction:** N/A\n` +
                            `**Life:** N/A\n\n` +
                            `Please send the **${amount}** to the staff. You can click the profile link or search the name or ID of the staff.\n\n` +
                ...
                await interaction.update({
                    ...
                    embeds: [
                        new EmbedBuilder()
                            .setColor(0x00ff00)
                            .setTitle(
                                "The buyer needs help from the staff."
                            )
                    ],
                    components: []
                });
